...
export default function TierCard({
  ...
  const passName = tier.id.includes("ls-")
    ? "Leadership Summit Pass"
    : "Rising Leaders Pass";
  ...
  const showStackedEffect =
    hasAddons && ((isActive && !isExpanded) || isSoldOut);
            ...
            <div className="flex-1 min-w-0">
              ...
              <h3
                ...
                style={{
                  ...
                  textDecoration:
                    isSoldOut || isExpired ? "line-through" : "none",
                }}
              >
                {passName}
              </h3>
