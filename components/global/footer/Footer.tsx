...
const quickLinks = [
  ...
  {
    label: "Design Leadership Focused Organizations",
  ...
  return (
    <footer className="bg-page border-t border-white/10 overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr] gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.label} className="max-w-[150px]">
                  <Link
                    href={link.href}
                    target="_blank"
                    rel="noopener noreferrer"
      ...
      <div
        ...
        data-color="#80A8BA"
        data-type="1"
        data-category="No-code"
        data-date="May. 26"
        data-link="https://www.awwwards.com/sites/ux-india-2026"
      >
        <p>
