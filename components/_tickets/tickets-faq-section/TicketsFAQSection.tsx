...
export default function TicketsFAQSection() {
  const [activeFilter, setActiveFilter] =
    useState<FilterType>("leadership-summit");
          ...
          >
            ...
            >
              {filteredFAQs.map((item) => (
                ...
                >
                  <AccordionTrigger className="py-6 text-left text-lg md:text-xl font-semibold text-white hover:no-underline [&[data-state=open]>svg]:rotate-180 [&>svg]:text-brand">
                    {item.question}
                  </AccordionTrigger>
