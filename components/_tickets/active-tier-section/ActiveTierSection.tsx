...
import TierCard from "@/components/ui/tier-card/TierCard";
import AddonCard from "@/components/ui/addon-card/AddonCard";
...
function TierWithAddons({
  ...
  const cardTextColor =
    event.id === "rising-leaders-forum" ? "#1A1000" : "#FFFFFF";
      ...
      {hasActiveTiers && (
        <div className="flex justify-center mt-2">
          <a
            ...
            className="py-3 px-8 rounded-full text-center font-sans font-semibold text-sm text-white bg-brand transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-brand/30 inline-flex items-center gap-2"
          >
            Buy tickets
            <svg
              width="14"
