...
import TierCard from "../../ui/tier-card/TierCard";
      ...
      >
        ...
        {!isExpanded && hasMultiple && (
          <>
            {/* Bottom stack card */}
            <div
              className="absolute left-2 right-2 top-4 h-full rounded-xl transition-all duration-300"
              style={{
            ...
            {/* Middle stack card */}
            <div
              className="absolute left-1 right-1 top-2 h-full rounded-xl transition-all duration-300"
              style={{
