...
import ActiveTierSection from "../active-tier-section/ActiveTierSection";
import SoldOutSection from "../sold-out-section/SoldOutSection";
import ComingSoonSection from "../coming-soon-section/ComingSoonSection";
import ComingSoonMarquee from "../../ui/coming-soon-marquee/ComingSoonMarquee";
...
export default function TicketsSection() {
  ...
  const svgSpinRef = useRef<HTMLImageElement>(null);
  ...
  if (!currentTime) {
    return (
      <section className="bg-page min-h-screen pt-32 pb-24">
  ...
  const hasComingSoon =
    lsUpcomingTiers.length > 0 || rlfUpcomingTiers.length > 0;

  return (
    <section className="bg-page min-h-screen pt-32 pb-24 relative overflow-hidden">
      {/* Decorative SVG at top */}
      <div
        className="absolute left-1/2 pointer-events-none select-none opacity-60 border-none"
        style={{
          top: "-500px",
          width: "1000px",
          height: "1000px",
      ...
      >
        <img
          ref={svgSpinRef}
          src="icons/tickets/five-days-object.svg"
          alt=""
      ...
      <div className="relative z-10">
        ...
        <div className="text-center px-6 mb-16">
          ...
          <p className="font-sans text-sm text-white/40 max-w-md mx-auto">
            Get your ticket to UXINDIA 2026 — Leadership Summit or Rising
            Leaders Forum.
          </p>
        </div>
