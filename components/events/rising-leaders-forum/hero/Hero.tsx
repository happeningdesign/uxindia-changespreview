  ...
  return (
    <section className="relative w-full bg-black">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('images/bg/rising-leaders-forum/rising-leaders-hero.webp')",
      ...
      <div className="relative z-10 min-h-screen flex flex-col pt-24 md:pt-32 pb-0">
        ...
        <div className="flex-1 flex flex-col justify-center pl-6 md:pl-20 lg:pl-32 pr-6 pb-24">
          <div className="max-w-6xl">
            ...
            >
              For emerging design leaders, mid-career designers, design
              students, and professionals transitioning into leadership roles
              who are ready to grow their influence, sharpen their strategic
            ...
            >
              ...
              <div className="md:border-r md:border-white/15 md:pr-8 md:mr-8">
                ...
                <p className="font-sans text-base md:text-lg text-white font-medium">
                  <span className="whitespace-nowrap">26–27 September</span>
                  <br />
                  2026
                </p>
              </div>
              ...
              <div className="md:border-r md:border-white/15 md:pr-8 md:mr-8 md:max-w-[280px]">
                ...
                >
                  <img
                    src="/icons/events/venue-location-icon.png"
                    alt=""
                    width="18"
                    height="18"
        ...
        {!hideTabBar && (
          <div className="w-full flex border-t border-white/10 bg-black/40 backdrop-blur-md">
            <button
              ...
              className={`flex-1 py-4 px-6 font-sans text-base md:text-lg font-medium transition-all duration-300 border-b-[3px] cursor-pointer ${
                activeTab === "overview"
