...
const leelaImages = [
  {
    src: "/images/carousel/leadership-summit/leela-bharatiya-city-1.jpg",
    alt: "The Leela Bhartiya City exterior",
  },
  {
    src: "/images/carousel/leadership-summit/leela-bharatiya-city-2.jpg",
    alt: "The Leela Bhartiya City grounds",
  },
  {
    src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Falak_1920x950-Et7Dn5Fr1hLfdCGK3z7R6Q7GsrTtKu.webp",
    alt: "Falak rooftop bar and restaurant at The Leela Bhartiya City",
  },
  {
    src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/UXI23-Stay-Leela-Bhartiya-City-Library-scaled-XfOxzfLy6rBCbpXaty2P9LHZaZ4dpC.webp",
    alt: "The Leela library lounge with chandelier",
  },
  {
    src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/e77b65eeb6514eeeaae4fde89c081217_large%21_%2169b5792c5ab81b513e75f14b1dd61e79-xanlbB9gkQpkolPD4J6E4rXTgrR4tr.webp",
    alt: "Grand foyer corridor at The Leela Bhartiya City",
  },
];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              >
                An iconic five-star destination known for its grandeur,
                world-class amenities, and impeccable hospitality. The perfect
                setting for design leaders to connect, collaborate, and shape
                the future.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p
                    className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}
                  >
                    Kempegowda International Airport (BLR) is approximately 35
                    km from the venue, with convenient taxi and ride-share
                    options available.
                  </p>
                </div>
                ...
                <div>
                  ...
                  >
                    ...
                    cities. The venue is accessible via metro and local
                    transport.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p
                    className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}
                  >
                    Kempegowda Bus Station (Majestic), the city&apos;s main
                    KSRTC and BMTC terminal, offers extensive intercity and
                    local connectivity, with taxis and ride-shares available to
                    the venue.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p
                  className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}
                >
                  Located in the heart of Bengaluru, our venue is easily
                  accessible by all major modes of transportation. Use the map
                  to get directions or click the button to open full directions
                  in Google Maps.
                </p>
              </div>
