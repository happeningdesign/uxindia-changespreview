          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}>
                  Located in the heart of Bengaluru, our venue is easily accessible by all major modes of transportation. Use the map below to get directions or click the button to open full directions in Google Maps.
                </p>
              </div>
