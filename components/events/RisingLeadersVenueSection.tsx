...
const risingLeadersImages = [
  { src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rs-7-l37vsH3BAFUJYnt5g6uYy2Uh2dK1VF.jpg", alt: "Rising Leaders Forum institutional courtyard" },
  { src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rs-4-ACymYQT4sHxhbgeSagcdV3NzDzVYvq.jpg", alt: "Modern colorful building facade" },
  { src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rs-01-b0OjC5SkyFzaVmeNz16Ud6nivBfp1h.jpg", alt: "Outdoor plaza with MARC letters" },
  { src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rs-5-frXOzUUKWwTbI4mB6W4AEMI9DYeTGP.jpg", alt: "Modern auditorium interior" },
  { src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rs-3-yXw0PdCil11cPoP2ITktj605qhxlCg.jpg", alt: "Outdoor sculpture installation" },
  { src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rs-2-kZgqJ91phUfePQayRXzq7cWjUKQPm7.jpg", alt: "Circular building with MAHE'RU letters" },
  { src: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rs-6-wFTuicMv70nASbC8xZHhkFK3cyiyRl.jpg", alt: "Modern auditorium with stage and lighting" },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}>
                A world-class venue designed to inspire and nurture the next generation of design leaders. With state-of-the-art facilities, collaborative spaces, and modern amenities, it provides the perfect environment for learning, networking, and innovation.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}>
                    Kempegowda International Airport is the nearest major airport with convenient taxi and ride-share options available to reach the venue.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}>
                    Bengaluru City Railway Station is well-connected to major cities. The venue is easily accessible via metro and local transportation.
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className={`font-sans text-sm leading-relaxed ${isLight ? "text-white/70" : "text-white/60"}`}>
                  Located in Bengaluru, our venue is easily accessible by all major modes of transportation. Use the map to get directions or click the button to open full directions in Google Maps.
                </p>
              </div>
