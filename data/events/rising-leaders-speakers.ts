  ...
  },
  {
    ...
    events: {
      rising: {
        ...
        keyTakeaway: [
          "AI can accelerate Design Thinking, but should not replace it. Teams can use AI to synthesize research, generate ideas, map workflows, and create prototypes fasterâ€”but user empathy, problem framing, and human judgment still guide the work.",
