  ...
  // },
  {
    ...
    events: {
      rising: {
        ...
        description: "This workshop starts by confronting the gap between AI hype and day-to-day reality in UX teams: scattered experiments, duplicated effort, unclear ownership, and anxiety about relevance. Participants will work in small groups to map their current discovery-design-delivery pipeline, then layer on where AI is already used (or could be used) for research, ideation, content, prototyping, documentation, and stakeholder communication. We then introduce a set of practical design-ops components working agreements, checklists, templates, review frameworks, learning paths and use these to redesign each group workflow into an AI-augmented UX operating system. Along the way, we address budgeting and staffing implications: which skills to hire for, how to re-scope roles, and how to communicate the new practice to leadership and teams who just don't get it. The session includes short demos, guided canvases, and peer critique.",
        keyTakeaway: [
      "A clear map of your current UX workflow and its biggest friction points.",
      "A customized â€œAI-augmented UX operating systemâ€ canvas you can take back to your team.",
