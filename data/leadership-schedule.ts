export const leadershipScheduleData = {
  ...
  day3: [
    ...
    },
    {
      ...
      sessions: [
        { room: "Room 1", title: "Spark Session", tag: "Spark Session", speaker: { name: "Vyoma Pathak", role: "Sr. Design Practice Lead, MOURI Tech", image: "" }, description: "Stepping beyond UI generation to explore what design judgment looks like when anyone can design." },
