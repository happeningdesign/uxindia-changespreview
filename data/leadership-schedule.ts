export const leadershipScheduleData = {
  ...
  day2: [
    ...
    { time: "11:25 AM", type: "keynote", title: "Be[coming] a leader in design", description: "A keynote on what it really takes to lead with integrity in design — without losing yourself to politics or pressure.", speaker: { name: "Mario Van der Meulen", role: "CXO Aleph Labs", image: "" }, tag: "Plenary Keynote" },
    ...
    { time: "3:40 PM", type: "keynote", title: "Plenary Keynote", description: "", speaker: { name: "TBA", role: "", image: "" }, tag: "Plenary Keynote" },
    { time: "4:20 PM", type: "break", title: "Coffee Break & Networking" },
    { time: "5:20 PM", type: "keynote", title: "Plenary Keynote", description: "", speaker: { name: "TBA", role: "", image: "" }, tag: "Plenary Keynote" },
