export const leadershipScheduleData = {
  ...
  day2: [
    ...
    { time: "11:25 AM", type: "keynote", title: "ghh", description: "A keynote on what it really takes to lead with integrity in design — without losing yourself to politics or pressure.", speaker: { name: "Mario Van der Meulen", role: "CXO Aleph Labs", image: "/LS-Speaker-Images/Van-Mario.webp" }, tag: "Plenary Keynote" },
