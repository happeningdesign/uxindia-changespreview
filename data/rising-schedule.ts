export const risingScheduleData = {
  ...
  day1: [
    ...
    { time: "9:40 AM", type: "keynote", title: "Deep Dive Talk", description: "", tag: "Deep Dive", location: "Auditorium", speaker: { name: "TBA", role: "", image: "" } },
  ...
  day2: [
    { time: "8:00 AM", type: "break", title: "Registrations", location: "Auditorium" },
    { time: "9:00 AM", type: "keynote", title: "Opening Keynote", description: "Announcing Soon", tag: "Keynote", location: "Auditorium", speaker: { name: "TBA", role: "Design Leader", image: "" } },
    { time: "9:40 AM", type: "keynote", title: "Deep Dive Talk", description: "Announcing Soon", tag: "Deep Dive", location: "Auditorium", speaker: { name: "TBA", role: "Design Leader", image: "" } },
    ...
    },
    {
      ...
      sessions: [
        { room: "Mini-Auditorium 1", title: "Spark Session", type: "spark", tag: "Spark Session", speaker: { name: "TBA", role: "Expert", image: "" }, description: "Quick insights on design innovation." },
        { room: "Mini-Auditorium 2", title: "Spark Session", type: "spark", tag: "Spark Session", speaker: { name: "TBA", role: "Expert", image: "" }, description: "Quick insights on design strategy." },
        { room: "Mini-Auditorium 3", title: "Spark Session", type: "spark", tag: "Spark Session", speaker: { name: "TBA", role: "Expert", image: "" }, description: "Quick insights on design operations." },
      ],
    },
    {
      time: "12:30 PM", type: "parallel-sessions", duration: "25 min",
      sessions: [
        { room: "Mini-Auditorium 1", title: "Spark Session", type: "spark", tag: "Spark Session", speaker: { name: "TBA", role: "Expert", image: "" }, description: "Quick insights on design thinking." },
        { room: "Mini-Auditorium 2", title: "Spark Session", type: "spark", tag: "Spark Session", speaker: { name: "TBA", role: "Expert", image: "" }, description: "Quick insights on user research." },
        { room: "Mini-Auditorium 3", title: "Spark Session", type: "spark", tag: "Spark Session", speaker: { name: "TBA", role: "Expert", image: "" }, description: "Quick insights on design systems." },
      ],
    },
    { time: "12:55 PM", type: "break", title: "Lunch", location: "Multiple Areas" },
    { time: "2:00 PM", type: "keynote", title: "Deep Dive Talk", description: "Announcing Soon", tag: "Deep Dive", location: "Auditorium", speaker: { name: "TBA", role: "Design Leader", image: "" } },
    { time: "2:40 PM", type: "keynote", title: "Deep Dive Talk", description: "Announcing Soon", tag: "Deep Dive", location: "Auditorium", speaker: { name: "TBA", role: "Design Leader", image: "" } },
    { time: "3:20 PM", type: "keynote", title: "Closing Ceremony", description: "Announcing Soon", tag: "Closing", location: "Auditorium", speaker: { name: "TBA", role: "Conference Host", image: "" } },
