  ...
  },
  {
    ...
    events: {
      rising: {
        ...
        keyTakeaway: ["Inject AI into high friction tasks within Figma and documentation workflows to free up space for high level UX strategy and research synthesis.", "A framework for moving beyond simple execution to using tools like Antigravity and Claude as collaborators that challenge your design assumptions.", "Learn how to identify when algorithmic convenience flattens original thinking and how to push past predictable, AI generated defaults.", "Learn to identify when algorithmic convenience flattens original thinking and use strategies to reinvest saved time into deep reflection, ethics, and the human nuance that machines cannot replicate."],
        audience: "",
      },
    },
  },
