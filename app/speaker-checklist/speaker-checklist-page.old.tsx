...
const venueInfo = [
  {
    ...
    value: "Sep 23–25, 2026",
    sub: "Leela Bhartiya City, Bengaluru",
  },
  {
    label: "Rising Leaders Summit",
    value: "Sep 26–27, 2026",
        ...
        <section className="py-16 md:py-24 bg-cream">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <AnimatedSection className="mb-16">
              ...
              <div className="mt-6 p-4 bg-page/5 rounded-xl border border-page/10">
                <p className="font-sans text-sm text-page/60 leading-relaxed">
                  <strong className="text-page/80">Important:</strong> Wi-Fi at
                  the venue is not guaranteed. If your session requires internet
                  access — for a live demo, live tool, or workshop exercise —
                  please arrange a personal mobile hotspot with sufficient data
                  (~1–2 GB recommended).
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection className="mb-16">
              ...
              <p className="font-sans text-base text-page/60 leading-relaxed mb-6">
                UXINDIA is a curated community experience. These principles help
                maintain the quality and respect that make the conference
                distinctive.
              </p>
            ...
            <AnimatedSection className="mb-16">
              <Callout>
                ...
                <p className="font-sans text-base text-[#333333] leading-relaxed">
                  Please be patient, generous, and kind — especially when things
                  are moving fast. A little warmth from speakers makes an
                  enormous difference to the whole team.
                </p>
              </Callout>
            </AnimatedSection>
