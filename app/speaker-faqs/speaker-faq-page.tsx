    ...
    <AnimatedSection className="mb-16">
      ...
      <Accordion type="single" collapsible className="w-full">
        {items.map((item, index) => (
          ...
          >
            <AccordionTrigger className="py-5 text-left text-base md:text-lg font-semibold text-page hover:no-underline [&[data-state=open]>svg]:rotate-180 [&>svg]:text-brand">
              {item.question}
            </AccordionTrigger>
            <AccordionContent className="text-page/60 text-base leading-relaxed pb-6">
              {item.answer}
            </AccordionContent>
          </AccordionItem>
        ))}
...
const faqGroups = [
      ...
      },
      {
        ...
        answer: (
          <>
            <p>
              The{" "}
              <strong className="text-page">Design Leadership Summit</strong>{" "}
            ...
            <p className="mt-3">
              The <strong className="text-page">Rising Leaders Forum</strong>{" "}
        ...
        answer: (
          <ul className="space-y-2 list-none">
            {[
              [
                "Grand Keynote",
                "Around 40 minutes, with additional time for Q&A",
              ],
              ...
              <li key={format} className="flex gap-2">
                <span className="text-brand font-semibold shrink-0">→</span>
                <span>
                  <strong className="text-page">{format}:</strong> {duration}
                </span>
              </li>
            ))}
          </ul>
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: "I submitted my interest earlier. Do I need to submit again?",
        answer:
      ...
      {
        question: "Do I need to submit a complete slide deck with my proposal?",
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: "Will selected speakers get access to both events?",
        answer:
    ...
    items: [
      {
        ...
        answer: (
          <>
            ...
            <strong className="text-page">Apply to Speak</strong>. The detailed
            speaker submission form is available from the website. You can also
            submit directly at{" "}
            <Link
      ...
      },
      {
        ...
        answer: (
          <>
            ...
            <strong className="text-page">May 24, 2026</strong>.
          </>
        ),
      },
      {
        ...
        answer: (
          <>
            ...
            <p className="mt-3">
              ...
              <strong className="text-page">Bapu Kaladhar</strong> on LinkedIn
              for relevant speaker-related questions or suggestions.
            </p>
          </>
        ),
      },
      ...
      <main className="min-h-screen bg-cream">
          ...
          <div className="relative z-10 min-h-[calc(70vh-100px)] flex flex-col justify-end pb-16 md:pb-24 px-6">
            <div className="max-w-5xl mx-auto w-full">
              ...
              >
                ...
                <span className="text-brand">Deadline: May 24, 2026</span>
              </motion.p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-cream">
          <div className="max-w-4xl mx-auto px-6">
            {/* Intro callout */}
            <AnimatedSection>
              <div className="bg-gradient-to-r from-brand/10 to-brand/5 border-l-4 border-brand p-6 md:p-8 rounded-r-2xl mb-16">
            ...
            <AnimatedSection>
              <div className="bg-gradient-to-r from-brand/10 to-brand/5 border-l-4 border-brand p-6 md:p-8 rounded-r-2xl mb-8">
                <p className="font-sans text-base md:text-lg text-[#333333] leading-relaxed mb-3">
                  <strong className="text-brand">A final note.</strong> UXINDIA
                  has always been a platform where many first-time speakers
                  found their voice and where experienced leaders shared ideas
                  that shaped the design community.
                </p>
                <p className="font-sans text-base text-[#333333] leading-relaxed">
            ...
            <AnimatedSection>
              <div className="bg-page text-white p-8 md:p-10 rounded-3xl">
                ...
                <p className="font-sans text-white/70 mb-8 max-w-lg">
                  Visit the speaker submission form to share your idea.
