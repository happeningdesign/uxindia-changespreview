...
function SubSection({
  ...
  return (
    <div className="mb-8">
      <h3 className="font-sans text-xl font-semibold text-page mb-4">
        {title}
      </h3>
      {children}
    </div>
...
function ListItem({ children }: { children: React.ReactNode }) {
  return (
    <li className="flex gap-3 mb-3">
      <span className="text-brand font-semibold mt-0.5 shrink-0">→</span>
...
function TableOfContents() {
  ...
  return (
    <div className="bg-page/5 rounded-2xl p-6 md:p-8 mb-12">
      <h3 className="font-sans text-lg font-semibold text-page mb-4">
        Contents
      </h3>
      <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
        {sections.map((section) => (
          <li key={section.id}>
            <a
              href={`#${section.id}`}
              className="flex items-center gap-2 font-sans text-sm text-[#333333] hover:text-brand transition-colors py-1"
            >
      ...
      <main className="min-h-screen bg-cream">
        ...
        >
          <motion.div className="absolute inset-0" style={{ y: heroY }}>
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-b from-page/70 via-page/60 to-page/80" />
          </motion.div>
          ...
          <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6">
            ...
            >
              ...
              <p className="font-sans text-base md:text-lg text-white/70 max-w-2xl mx-auto leading-relaxed">
                ...
                attending, or participating in UXINDIA Design Leadership Week
                2026
              </p>
            </motion.div>
          </div>
        ...
        <section className="py-16 md:py-24">
          <div className="max-w-4xl mx-auto px-6">
            <p className="font-sans text-sm text-page/50 text-center mb-12">
            ...
            <AnimatedSection>
              <div id="acceptance" className="mb-16 scroll-mt-24">
                ...
                <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                  ...
                  &quot;Event&quot; or &quot;UXINDIA 2026&quot;), organized by
                  UMO Design Foundation (the &quot;Organizer,&quot;
                  &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). These
                  Terms and Conditions (&quot;Terms&quot;) constitute a legally
                  binding agreement between you and UMO Design Foundation.
                </p>
                <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                ...
                <Notice>
                  <p>
                    ...
                    Event. Your continued participation constitutes acceptance
                    of these Terms as they may be amended from time to time.
                  </p>
                </Notice>
              </div>
            </AnimatedSection>
              ...
              <div id="definitions" className="mb-16 scroll-mt-24">
                ...
                <ul className="list-none mb-4">
                  <ListItem>
                    ...
                    (September 23-25, 2026) and the Rising Leaders Forum
                    (September 26-27, 2026), held in Bengaluru, India.
                  </ListItem>
                  <ListItem>
                    <strong>&quot;Participant&quot;</strong> means any
                    individual or entity involved with the Event, including
                    attendees, speakers, sponsors, exhibitors, partners,
                    volunteers, staff, media representatives, and any other
                    person accessing Event facilities or content.
                  </ListItem>
                  <ListItem>
                  ...
                  <ListItem>
                    ...
                    property created for, presented at, or distributed during
                    the Event.
                  </ListItem>
                </ul>
              </div>
              ...
              <div id="registration" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="3.1 Registration Requirements">
                  ...
                  <ul className="list-none mb-4">
                    ...
                    <ListItem>
                      Badges are non-transferable unless prior written approval
                      is obtained from the Organizer
                    </ListItem>
                  </ul>
                </SubSection>
                ...
                <SubSection title="3.2 Payment Terms">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    Registration fees must be paid in full at the time of
                    booking unless otherwise agreed in writing. All fees are
                    quoted in Indian Rupees (INR) and are exclusive of
                    applicable Goods and Services Tax (GST), which will be
                    charged at the prevailing rate.
                  </p>
                  <ul className="list-none mb-4">
                    <ListItem>
                      Payment can be made via credit card, debit card, net
                      banking, UPI, or other methods specified on the
                      registration platform
                    </ListItem>
                    <ListItem>
                      For corporate or bulk registrations (5+ attendees),
                      invoice and bank transfer options may be available upon
                      request
                    </ListItem>
                    <ListItem>
                ...
                <SubSection title="3.3 Ticket Categories & Access">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    ...
                    components. Participants should carefully review their
                    ticket entitlements:
                  </p>
                  <ul className="list-none mb-4">
                    <ListItem>
                      <strong>Leadership Summit Pass:</strong> Access to
                      September 23-25 programming, including keynotes, plenary
                      sessions, leadership tracks, and networking events.
                    </ListItem>
                    <ListItem>
                    ...
                    <ListItem>
                      <strong>Full Event Pass:</strong> Access to all five days
                      of programming (September 23-27).
                    </ListItem>
                    <ListItem>
                      <strong>Workshop Pass:</strong> Separate registration for
                      specific workshops or masterclasses, which may have
                      limited capacity.
                    </ListItem>
                  </ul>
                </SubSection>
            ...
            <AnimatedSection>
              <div id="cancellation" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="4.1 Cancellation by Attendee">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    Attendees who wish to cancel their registration must submit
                  ...
                  <ul className="list-none mb-4">
                    ...
                    <ListItem>
                      <strong>30-60 days before the Event:</strong> 50% refund
                    ...
                    <ListItem>
                      No-shows (failure to attend without prior cancellation)
                  ...
                  <p className="font-sans text-base text-[#333333] leading-relaxed">
                    ...
                    approval to the original payment method. Transaction fees
                    and GST are non-refundable.
                  </p>
                </SubSection>
                ...
                <SubSection title="4.2 Ticket Transfers">
                  ...
                  <ul className="list-none mb-4">
                    ...
                    <ListItem>
                      A transfer fee of INR 1,000 applies to each transfer
                      request
                    </ListItem>
                    <ListItem>Tickets can only be transferred once</ListItem>
                    <ListItem>
                      Unauthorized transfers or badge sharing may result in
            ...
            <AnimatedSection>
              <div id="event-changes" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="5.1 Right to Modify Event">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    The Organizer reserves the right to make changes to any
                    aspect of the Event without prior notice or liability,
                ...
                <SubSection title="5.2 Force Majeure">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    ...
                    obligations if such failure results from circumstances
              ...
              <div id="speakers" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="6.1 Speaker Obligations">
                  ...
                  <ul className="list-none mb-4">
                    ...
                    <ListItem>
                      Submit presentation materials by the deadlines specified
                    ...
                    <ListItem>
                      Avoid promotional or sales-focused content unless
                ...
                <SubSection title="6.2 Speaker Benefits">
                  ...
                  <p className="font-sans text-base text-[#333333] leading-relaxed">
                    <strong>Honorarium:</strong> As a not-for-profit
                    organization, UXINDIA does not provide speaker fees or
                    honoraria. Speakers contribute to support the Event&apos;s
                    mission of advancing design leadership.
                  </p>
                </SubSection>
              </div>
            </AnimatedSection>
              ...
              <div id="sponsors" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="7.1 Sponsor Obligations">
                  ...
                  <ul className="list-none mb-4">
                    ...
                    <ListItem>
                      Provide required materials (logos, collateral, booth
                      assets) by specified deadlines
                    </ListItem>
                    <ListItem>
                ...
                <SubSection title="7.2 Sponsor Cancellation">
                  ...
                  <ul className="list-none mb-4">
                    <ListItem>
                      Cancellations more than 90 days before the Event: 50%
                    ...
                    <ListItem>
                      Cancellations less than 60 days before the Event: No
                      refund
                    </ListItem>
                  </ul>
                </SubSection>
            ...
            <AnimatedSection>
              <div id="attendees" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="8.2 Prohibited Conduct">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    The following behaviors are strictly prohibited and may
                ...
                <SubSection title="8.3 Badge Requirements">
                  ...
                  <ul className="list-none mb-4">
                    <ListItem>
                      Wear official Event badges visibly at all times within
                      Event venues
                    </ListItem>
                    <ListItem>
                    ...
                    <ListItem>
                      Report lost or stolen badges immediately to Event staff
                      for replacement
                    </ListItem>
                  </ul>
                </SubSection>
            ...
            <AnimatedSection>
              <div id="intellectual-property" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="9.1 Ownership of Event Materials">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    All Event-produced materials, including but not limited to
                    the Event logo, branding, website design, marketing
                    collateral, program guide, signage, and official recordings
                    are the exclusive property of UMO Design Foundation and are
                ...
                <SubSection title="9.2 Unauthorized Recording & Distribution">
                  ...
                  <ul className="list-none mb-4">
                    <ListItem>
                      Photography, video recording, or audio recording of
                      sessions is <strong>prohibited</strong>
                    </ListItem>
                    <ListItem>
            ...
            <AnimatedSection>
              <div id="media" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="10.1 Organizer's Rights">
                  ...
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    Your image, voice, likeness, statements, and participation
                    may appear in:
                  </p>
                  <ul className="list-none mb-4">
                    <ListItem>
                ...
                <SubSection title="10.2 Opt-Out Requests">
                  <p className="font-sans text-base text-[#333333] leading-relaxed">
                    ...
                    complete avoidance of capture cannot be guaranteed in public
                    Event spaces.
                  </p>
                </SubSection>
              </div>
              ...
              <div id="liability" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="11.1 Limitation of Liability">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    ...
                    directors, officers, employees, volunteers, agents,
                    sponsors, and partners shall not be liable for any direct,
                ...
                <SubSection title="11.2 Assumption of Risk">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    Participants acknowledge and assume all risks associated
                    with Event attendance, including but not limited to:
                  </p>
                  <ul className="list-none mb-4">
                    <ListItem>
                ...
                <SubSection title="11.3 Insurance">
                  <p className="font-sans text-base text-[#333333] leading-relaxed">
                    ...
                    insurance, health insurance, and personal property
                    insurance. The Organizer does not provide insurance coverage
                    for Participants.
                  </p>
                </SubSection>
              </div>
              ...
              <div id="data-privacy" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="12.2 Data Collection">
                  ...
                  <ul className="list-none mb-4">
                    ...
                    <ListItem>
                      Dietary restrictions, accessibility requirements, and
                      other special needs
                    </ListItem>
                    <ListItem>
              ...
              <div id="international" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="13.1 Visa Requirements">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    ...
                    have appropriate visa documentation for entry into India.
                    The Organizer can provide invitation letters to support visa
                    applications upon request, but cannot guarantee visa
                    approval.
                  </p>
                  <ul className="list-none mb-4">
                    <ListItem>
                ...
                <Notice type="warning">
                  <p>
                    ...
                    guarantee visa approval. The Organizer is not responsible
                    for visa denials, delays, or processing times. The Organizer
                    is not liable for travel or accommodation costs incurred due
                    to visa issues.
                  </p>
                </Notice>
                ...
                <SubSection title="13.2 Language & Time Zone">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    The official language of the Event is English. All Event
                    times are listed in Indian Standard Time (IST, UTC+5:30).
            ...
            <AnimatedSection>
              <div id="health-safety" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="14.1 Health Requirements">
                  ...
                  <ul className="list-none mb-4">
                    <ListItem>
                      Comply with any health and safety protocols in effect at
                ...
                <SubSection title="14.3 Personal Property">
                  <p className="font-sans text-base text-[#333333] leading-relaxed">
                    ...
                    personal belongings at all times. The Organizer and venue
                    are not responsible for loss, theft, or damage to personal
                    property. Participants should not leave valuables
                    unattended.
                  </p>
                </SubSection>
              </div>
              ...
              <div id="jurisdiction" className="mb-16 scroll-mt-24">
                ...
                <SubSection title="15.2 Jurisdiction & Venue">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    ...
                    relating to these Terms, the Event, or any
                    Participant&apos;s involvement shall be subject to the{" "}
                    <strong>
                ...
                <SubSection title="15.3 Severability">
                  <p className="font-sans text-base text-[#333333] leading-relaxed mb-4">
                    ...
                    jurisdiction, the remaining provisions shall continue in
                ...
                <SubSection title="15.4 Entire Agreement">
                  <p className="font-sans text-base text-[#333333] leading-relaxed">
                    ...
                    Conduct, and any applicable sponsorship or speaker
                    agreements, constitute the entire agreement between the
                    Participant and the Organizer regarding the Event.
                  </p>
                </SubSection>
              </div>
            </AnimatedSection>
            ...
            {/* Acknowledgment */}
            <AnimatedSection>
              <div className="bg-brand/10 border border-brand/30 rounded-2xl p-6 md:p-8">
                ...
                <p className="font-sans text-sm text-[#333333] leading-relaxed">
                  Thank you for being part of UXINDIA 2026. We look forward to
                  an inspiring and transformative event together.
                </p>
              </div>
            </AnimatedSection>
          </div>
